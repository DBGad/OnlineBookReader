...
int ShowReadMenu(const vector<string>& choices) {
	...
	return clsInputValidate::ReadIntNumberBetween(1,choices.size());
}
class book {
private:
    string ispn;
...
public:
    ...
    ReadingSession(const book& b) :
        Book(b), current_page(0), last_access(clsDate::GetSystemDateTimeString()) {
    }
    void setbook(book& B) {
        Book = B;
    }
    ...
    void resetcurrentdateandtime() {
        last_access = clsDate::GetSystemDateTimeString();
    }
...
public:
    ...
    void loaddatabase() {
        user user1;
        user1.setusername("Gad");
        user1.setpassword("1470");
        user1.setemail("Gad@gmail.com");
        user1.setisadmin(true);
        user1.setname("Gad Amr Gadelhaq");
        user_object[user1.getusername()] = user1;

        user user2;
        user2.setusername("Body");
        user2.setpassword("1470");
        user2.setemail("Body@gmail.com");
        user2.setisadmin(false);
        user2.setname("Abdalla Amer Ashour");
...
public:
    ...
    void listreadinghistory() {
        ...
        int choice = clsInputValidate::ReadIntNumberBetween(1, idx);
